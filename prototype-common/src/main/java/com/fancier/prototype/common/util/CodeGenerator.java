...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        // 生成路径默认值
        String projectPath = System.getProperty("user.dir") + "/missingyou-common";
        ...
        // 生成 convert
        inputPath = projectPath + File.separator + "src/main/resources/templates/mapstruct/TemplateConvert.java.ftl";
        outputPath = String.format("%s/generator/mapstruct/%sConvert.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        System.out.println("生成 Convert 成功，文件路径：" + outputPath);
